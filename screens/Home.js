      ...
      <View
        ...
        <View
          ...
          <View
            ...
            <Image
              source={selectCategory.icon}
              style={{
                width: 30,
                height: 30,
                tintColor: selectCategory.color,
              }}
            />
          </View>
          <Text style={{...FONTS.h3, color: selectCategory.color}}>
            {selectCategory.name}
          </Text>
        </View>
        ...
        <View style={{paddingHorizontal: SIZES.padding}}>
          ...
          {/* Location */}
          <Text style={{marginTop: SIZES.padding - 10, ...FONTS.h4}}>
            Location
          </Text>
          <View style={{flexDirection: 'row'}}>
            <Image
        ...
        <View
          style={{
            ...
            backgroundColor: selectCategory.color,
          }}>
      ...
      <View style={{alignItems: 'center', justifyContent: 'center'}}>
        <Svg
          ...
          <VictoryPie
            ...
            radius={({datum}) =>
              selectCategory && selectCategory.name == datum.name
                ? SIZES.width * 0.4
                : SIZES.width * 0.4 - 10
            }
            innerRadius={70}
        ...
        <View style={{position: 'absolute', top: '42%', left: '42%'}}>
          ...
          <Text style={{textAlign: 'center', ...FONTS.body3}}>Despesas</Text>
        </View>
      </View>
    );
  }
      ...
      return (
        <TouchableOpacity
          style={{
            ...
            backgroundColor:
              selectCategory && selectCategory.name == item.name
                ? item.color
                : COLORS.white,
          }} 
          onPress={() => {
          ...
          <View style={{justifyContent: 'center'}}>
            <Text style={{color: selectCategory && selectCategory.name == item.name ?  COLORS.white : COLORS.primary, ...FONTS.h3}}>
              R$ {item.y} - {item.label}
            </Text>
          </View>
        </TouchableOpacity>
